...
print "The purpose of this program is to trace Dijkstra's algorithm using
partially ordered tree as a priority queue and linked adjacency lists as the
...
x.printlist()
print "\n\n"
print "For each iteration, it should take the shorest path and add it to the
set of nodes you are using. Then it should update D so that the shortest
